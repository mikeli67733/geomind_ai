...
class RasterDiffChangeWidget(BaseLocalToolWidget):
    ...
    def _build_ui(self):
        ...
        self.combo_t1 = QgsMapLayerComboBox(); self.combo_t1.setFilters(RASTER_LAYER_FILTER)
        layer_v.addWidget(self.combo_t1)
        layer_v.addWidget(QLabel("变化期 (T2 后期):"))
        self.combo_t2 = QgsMapLayerComboBox(); self.combo_t2.setFilters(RASTER_LAYER_FILTER)
        ...
        self.spin_thresh = QDoubleSpinBox(); self.spin_thresh.setRange(1.0, 500.0); self.spin_thresh.setValue(30.0)
