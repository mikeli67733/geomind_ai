# -*- coding: utf-8 -*-
"""
套餐管理对话框（含闲鱼一键跳转与卡密兑换功能）
"""
import os
import webbrowser  # 引入 Python 自带的浏览器打开模块

from qgis.PyQt.QtCore import Qt
from qgis.PyQt.QtGui import QPixmap
from qgis.PyQt.QtWidgets import (
    QDialog, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QTabWidget,
    QWidget, QMessageBox
)
...
class PlanDialog(QDialog):
    ...
    def _build_pro_tab(self) -> QWidget:
        ...
        tip_box = QLabel("🛒 如何获取卡密？\n点击下方按钮前往闲鱼下单购买，付款后自动发货卡密，收到后粘贴在下方即可秒级兑换！")
    ...
    def _build_custom_tab(self) -> QWidget:
        ...
        desc = QLabel(CUSTOM_PLAN_CONTACT_TEXT + "（按解译区域面积计费，具体价格请联系作者报价）")
        desc.setWordWrap(True)
        v.addWidget(desc)
        ...
        if os.path.exists(qr_path):
            pixmap = QPixmap(qr_path).scaled(150, 150, Qt.KeepAspectRatio, Qt.SmoothTransformation)
    ...
    def _do_redeem(self):
        ...
        try:
            ...
            self.msg_label.setText(f"🎉 {res['message']}")
